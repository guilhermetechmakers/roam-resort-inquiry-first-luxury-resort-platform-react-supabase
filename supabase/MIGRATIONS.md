...
### 20250303000000_create_feedback_logs.sql
Creates `feedback_logs` table for internal feedback logging (non-actionable user messages like "Thank you."). Columns: id, source_url, page_title, message, sentiment, category, created_at. RLS allows anonymous insert.
